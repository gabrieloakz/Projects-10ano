...
int main()
{
   ...
   // enquanto nao for digitado -99, e caso seja digitado, encerrar
   ...
   // Ao digitar -99 desligamos a maquina e exibimos o faturamento
   
   cout << "Faturamento =" << (faturamento / 100) << "Euros\n\n" ;

   // Ao final de tudo temos uma sequencia de If's para ir verificando a quantidade vendida de cada produto
   // Armazenando o valor vendido na respectiva variavel q do produto
   // E entao ir verificando se o q é maior que 0, ou seja, se o produto fopo vendido
   // E se foi vendido exibir a quantidade devida
